...
class _MyMantraAudio extends State<MyMantraAudio> with TickerProviderStateMixin  {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Select mantra audio'),),
      body: SizedBox(
            height: MediaQuery
                .of(context)
                .size
                              ...
                              trailing: GestureDetector(
                                onTap: () {
                                  if (isCurrentSongPlaying) {
                                    ...
                                    mantraAudioPreviewIndex = index;
                                    playAudioPreview(AssetSource(mantraAudioAssetList[index]));
                                  }
                                  ...
                                  children: [
                                    ...
                                    if (isCurrentSongPlaying)
                                      CircularProgressIndicator(
                                        value: mantraAudioModel.previewPlaybackProgress,
